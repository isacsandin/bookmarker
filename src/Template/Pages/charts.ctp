...
$this->Html->addCrumb('Charts', ['controller' => 'Pages', 'action' => 'display', 'charts']);
...
<!--[if lte IE 8]><?= $this->Html->script('plugins/flot/excanvas.min.js') ?><![endif]-->
<?= $this->Html->script('plugins/flot/jquery.flot.js',['block'=>true]) ?>
<?= $this->Html->script('plugins/flot/jquery.flot.tooltip.min.js',['block'=>true]) ?>
<?= $this->Html->script('plugins/flot/jquery.flot.resize.js',['block'=>true]) ?>
<?= $this->Html->script('plugins/flot/jquery.flot.pie.js',['block'=>true]) ?>
<?= $this->Html->script('plugins/flot/flot-data.js',['block'=>true]) ?>
